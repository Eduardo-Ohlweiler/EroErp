...
export function TFieldList({
    ...
    function renderCell(
        ...
        switch (col.component) {
            ...
            case "custom":
                return col.render(rowIndex, rowData, (field, val) =>
                    updateField(rowIndex, field, val)
                )
        }
    }
    ...
    return (
        <div className="flex flex-col gap-2">
            <div className="w-full overflow-x-auto overflow-y-visible rounded-lg border border-(--border)">
                        ...
                        {rows.map((rowData, rowIndex) => (
                            ...
                            >
                                ...
                                {visibleColumns.map((col) => (
                                    <td
                                        key={col.name}
                                        className="px-2 py-1.5 align-middle overflow-visible"
                                    >
                                        {renderCell(col, rowIndex, rowData)}
                                    </td>
                                ))}
