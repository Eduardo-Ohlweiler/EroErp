...
export default function Sidebar({ collapsed }: SideBarProps) {
        ...
        return (
          ...
          >
            ...
            <button
              ...
              text-[#9da5b4] hover:text-[#e6edf3] hover:bg-[#2a313a] ${padding}`}
            >
            ...
            {!collapsed && open[item.label] && (
              <div className="mt-1 space-y-1 border-l border-[#30363d] ml-3 pl-3">
            ...
            {collapsed && hovered === item.label && (
              <div
                ...
                className="absolute left-full top-0 ml-2 bg-[#0e1116] border border-[#30363d] rounded-md shadow-xl p-2 min-w-[220px] z-50"
              >
                ...
                {item.children.map((child) => {
                  ...
                  if (child.children && child.children.length > 0) {
                    return (
                      <div
                        key={child.label}
                        className="border-t border-[#30363d] mt-1 pt-1"
                      >

                        <div className="flex items-center gap-3 px-3 py-2 text-sm text-[#e6edf3]">
                        ...
                        {child.children.map((sub) => {
                          ...
                          return (
                            <Link
                              ...
                              text-[#9da5b4] hover:text-[#e6edf3] hover:bg-[#2a313a]"
                            >
          ...
          >
            ...
            {collapsed && hovered === item.label && (
              <div
                onMouseEnter={() => handleMouseEnter(item.label)}
                onMouseLeave={() => handleMouseLeave()}
                className="absolute left-full ml-2 top-1/2 -translate-y-1/2 bg-[#0e1116] border border-[#30363d] rounded-md px-3 py-2 text-sm shadow-lg whitespace-nowrap z-50"
              >
  ...
  return (
    ...
    <aside
      className={`${
        collapsed ? "w-16" : "w-64"
      } bg-[#0e1116] text-[#9da5b4] min-h-screen flex flex-col border-r border-[#30363d] transition-all duration-300`}
    >
