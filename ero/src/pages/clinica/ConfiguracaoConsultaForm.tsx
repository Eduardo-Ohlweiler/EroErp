...
export default function ConfiguracaoConsultaForm() {
    ...
    async function handleSalvar() {
        setSaving(true)
        try {
            await api.put("/consultas/configuracao", { faturarAoConcluir })
    ...
    if (loading) {
        return (
            <TPage title="Carregando..." breadcrumb={["Clínica", "Auxiliar Clínica", "Config. Consulta"]}>
    ...
    return (
        <TPage
            title      ="Configuração de Consulta"
            breadcrumb ={["Clínica", "Auxiliar Clínica", "Config. Consulta"]}
        >
            <TPanel title="Consulta">
                <TRow>
                    <TCol>
                        <TCombo
